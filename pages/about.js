                            ...
                            <div className="row d-flex align-items-center">
                                ...
                                <div className="col-md-6 order-last order-md-2">
                                    <div className="txt-block left-column wow fadeInRight">
                                        ...
                                        {/* Title */}
                                        <h2 className="s-50 w-700">Jose Rafael</h2>
                                        {/* Text */}
                                ...
                                <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
                                    ...
                                    <div className="col">
                                        <div className="team-member mb-50 wow fadeInUp">
                                            ...
                                            <div className="team-member-data">
                                                <h6 className="s-20 w-700 color--black">Jose Rafael</h6>
                                    ...
                                    <div className="col">
                                        <div className="team-member mb-50 wow fadeInUp">
                                            ...
                                            {/* Team Member Data */}
                                            <div className="team-member-data">
                                                <h6 className="s-20 w-700 color--black">Doand Panjaitan</h6>
                                                <p className="color--grey">Software Engineer</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col">
                                        <div className="team-member mb-50 wow fadeInUp">
                                            ...
                                            {/* Team Member Data */}
                                            <div className="team-member-data">
                                                <h6 className="s-20 w-700 color--black">Abi</h6>
                                                <p className="color--grey">Web Development</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col">
                                        <div className="team-member mb-50 wow fadeInUp">
                                            ...
                                            {/* Team Member Data */}
                                            <div className="team-member-data">
                                                <h6 className="s-20 w-700 color--black">Ilham</h6>
                                                <p className="color--grey">Web Development</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col">
                                        <div className="team-member mb-50 wow fadeInUp">
                                            ...
                                            {/* Team Member Data */}
                                            <div className="team-member-data">
                                                <h6 className="s-20 w-700 color--black">Putri</h6>
                                                <p className="color--grey">Business Plan</p>
                                            </div>
                                        </div>
